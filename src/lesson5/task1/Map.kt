...
fun buildGrades(grades: Map<String, Int>): Map<Int, List<String>> {
    ...
    for ((key, value) in grades) {
        if (res[value] != null) res[value] = res[value]!! + key
        else res[value] = list + key
    }
    return res.mapValues { it.value.sortedDescending() }
}
